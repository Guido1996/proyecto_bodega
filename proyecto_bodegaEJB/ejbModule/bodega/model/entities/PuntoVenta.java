...
public class PuntoVenta implements Serializable {
	...
	@Id
	@SequenceGenerator(name="PUNTO_VENTA_IDPTOVENTA_GENERATOR", sequenceName="PUNTO_VENTA",allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PUNTO_VENTA_IDPTOVENTA_GENERATOR")
	@Column(name="id_pto_venta")
	private Integer idPtoVenta;

	@Column(name="correo_pto_venta")
	private String correoPtoVenta;

	@Column(name="direccion_pto_venta")
	private String direccionPtoVenta;

	@Column(name="nombre_pto_venta")
	private String nombrePtoVenta;

	@Column(name="telefono_pto_venta")
